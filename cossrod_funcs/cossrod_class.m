classdef cossrod_class
    ...
    methods
        ...
        function obj = compute_dilatations(obj, pos_vect, volumes, rest_lengths, rest_voronoi_lengths)
            ...
            obj.compute_geom(pos_vect, volumes);
        ...
        function obj = update_shearStretch(obj, dir_vects, pos_vect,...
            ...
            obj.compute_dilatations(pos_vect, volumes, rest_lengths, rest_voronoi_lengths);
        ...
        function obj = update_internal_stresses(obj, dir_vects, pos_vects, volumes,...
                rest_lengths, rest_voronoi_lengths, sigma, shearMat, sigma_rest)
            obj.update_shearStretch(dir_vects, pos_vects,...
                volumes, rest_lengths, rest_voronoi_lengths);
            obj.internal_stress = batchMatVec(shearMat, sigma - sigma_rest);
        end

        function obj = compute_internal_forces(obj, dir_vects, pos_vects, volumes,...
                rest_lengths, rest_voronoi_lengths, sigma, shearMat, sigma_rest)

            obj.update_internal_stresses(dir_vects, pos_vects, volumes,...
                rest_lengths, rest_voronoi_lengths, sigma, shearMat, sigma_rest)
            ...
            obj.internal_forces = two_point_rule(cosserat_internal_stress, obj.nElems + 1);
        end
        ...
        function obj = compute_internal_bending_twist_strains_from_model(obj)
            obj.compute_bending_twist_strains(obj.dir_vects, obj.rest_voronoi_lengths);
        ...
        function obj = compute_internal_torques(obj)
            obj.compute_internal_bending_twist_strains_from_model();
            obj.compute_dilatation_rate(obj.pos_vects, obj.vel_vects);
        ...
        function obj = compute_internal_forces_and_torques(obj)
            obj.compute_internal_forces(obj.dir_vects, obj.pos_vects, obj.volumes,...
                obj.rest_lengths, obj.rest_voronoi_lengths, obj.sigma, obj.shearMat, obj.sigma_rest);
            
            obj.compute_internal_torques();
        end
